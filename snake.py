...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen_1("Welcome to Snake", blue, 100, 50)
        text_screen("Press Space_Bar To Play", b, 232, 500)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen(" press enter", red, 350, 500)
            ...
            text_screen("Score: " + str(score)+ "     highscore: "+str(highscore), lightblue, 380, 560)
